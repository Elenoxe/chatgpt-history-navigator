...
import { revealQuestion, loadQuestionHistory, setHistoryPaginationObservation } from '@/platform/chatgpt/navigation';
...
export default defineContentScript({
  ...
  main() {
    installNavigationHandlers(revealQuestion, loadQuestionHistory, setHistoryPaginationObservation);
